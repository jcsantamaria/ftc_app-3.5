...
*/
            ...
            case Bump: {
                ...
                if ( getRuntime() - timestamp > 1.5) {
                    state = BehaviorState.MoveForward;
                    timestamp = getRuntime();   // mark current time
            ...
            case MoveForward:
            {
                //TODO: use the delta: target - position to find out how much to turn and how much to drive forward
                // in the meantime, we just move forward for a period of time
                setDrivePower(0.5, 0.0, 0.0);
                if ( getRuntime() - timestamp > 3.0) {
